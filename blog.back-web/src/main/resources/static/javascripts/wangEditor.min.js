!function (e, t) {
    ...
    f.prototype = {
        ...
        constructor: Q, onClick: function (e) {
            ...
            this.editor.cmd.do("insertHTML", "<pre><code style='border:1px dashed #000'>" + e + "</code></pre><p><br></p>")
        ...
        constructor: S, onClick: function () {
            ...
            var n = void 0, i = void 0, o = '<table border="1" width="100%" cellpadding="0" cellspacing="0">';
            for (n = 0; n < e; n++) {
